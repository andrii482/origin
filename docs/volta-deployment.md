...
<div class="admonition attention">
  ...
  <pre>
   ...
   <br>   2. edit `.env` and set <br>   
    ...
    <br>    - `EXCHANGE_ACCOUNT_DEPLOYER_PRIV` to a private key with funded Volta account (for testing you can use `DEPLOY_KEY`) <br>   
    <br>   - `EXCHANGE_WALLET_PRIV` to a private key with funded Volta account (for testing you can use `DEPLOY_KEY`) <br>   
     <br>   - `EXCHANGE_WALLET_PUB` to a address of `EXCHANGE_WALLET_PRIV` <br>   
